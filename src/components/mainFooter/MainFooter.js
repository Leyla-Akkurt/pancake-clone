  ...
  return (
    ...
    <div id="mainFooter">
          <div id="mainFooter-smScreens">
            ...
            <div id="about">
              <ul>
                <li><a href="#" className="footerHeader">ABOUT</a></li>
            ...
            <div id="help">
              <ul>
                <li><a href="#" className="footerHeader">HELP</a></li>
            ...
            <div id="developers">
              <ul>
                <li><a href="#" className="footerHeader">DEVELOPER</a></li>
          ...
          <div id="mainfooterContents">
            <div id="mainfooterContentsIn">
              <div id="mainFooterUp">
                <div id="mainFooterUpLinks">
                  <div id="about">
                    <ul>
                      <li><a href="#" className="footerHeader">ABOUT</a></li>
                      <li><a href="#" id="contact">Contact</a></li>
                ...
                <div id="mainFooterUpIcons">
                  ...
                  <div id="telegramRegions">
                    ...
                    <div
                      id="telegramRegionChannel"
                      className="sc-ee5ec6ea-0 blPylB"
                    >
                      <a
                        target="_blank"
                        rel="noreferrer noopener"
                  ...
                  <div id="lang">
                    <button id="langEn" scale="md">
                      <svg
                        ...
                        width="24px"
                        xmlns="http://www.w3.org/2000/svg"
                        className="sc-4ba21b47-0 cmVGwA"
                      >
                        <path
                ...
                <div id="buyCake">
                  <div id="cakePrice">
                    <a href="#">
                      <svg
                        ...
                        color="text"
                        xmlns="http://www.w3.org/2000/svg"
                        className="sc-4ba21b47-0 hFKfwc"
                      >
                        <circle cx="48" cy="48" r="48" fill="#1FC7D4"></circle>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                  ...
                  <a href="#" id="buyCakeBtn">
                    ...
                    <div>
                      <svg
                        viewBox="0 0 24 24"
                        className="btn-color sc-4ba21b47-0 jxNZzw"
                        color="backgroundAlt"
                        width="20px"
                        xmlns="http://www.w3.org/2000/svg"
                      >
