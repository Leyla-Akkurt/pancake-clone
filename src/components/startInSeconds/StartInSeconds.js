...
function StartInSeconds() {
  return (
    <div id="startInSeconds" style={{position:"relative"}}>
          <div id="svgBg">
            <svg
              viewBox="0 0 1956 1956"
              className="sc-4ba21b47-0 IIbzK sc-abde09ff-1 hbyJdh"
              color="text"
              width="20px"
          ...
          <div id="startInWrapper">
            <div id="startInContainer">
              <div id="pancakeFlyingTop" className="flyingCake">
                <img
                  src="./images/home/flying-pancakes/1-left@2x.webp"
                  alt="cake1"
                  className="cake cake-left"
                />
                <img
                  src="./images/home/flying-pancakes/1-top@2x.webp"
                  alt="cake2"
                  className="cake cake-left"
                />
                <img
                  src="./images/home/flying-pancakes/1-bottom@2x.webp"
                  alt="cake3"
                  className="cake cake-left"
                />
              </div>
              ...
              <div className="cake-wrapper">
                <div className="cake-container">
                  <div id="pancakeFlyingBottom" className="flyingCake">
                    <img
                      src="./images/home/flying-pancakes/2-top@2x.webp"
                      className="cake cake-right"
                      alt="flying cake"
                    />
                    <img

                      src="./images/home/flying-pancakes/2-right@2x.webp"
                      alt="cake2"
                      className="cake cake-right"
                    />
                    <img
                      src="./images/home/flying-pancakes/2-bottom@2x.webp"
                      alt="cake3"
                      className="cake cake-right"
                    />
                  </div>
