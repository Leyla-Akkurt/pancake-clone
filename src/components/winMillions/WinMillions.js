    ...
    <section id="home-3" className="home-3">
      <div className="home-3-container">
        <div className="home-3-wrapper">
          <div className="home-3-assets">
            <div className="home-3-cards-container">
              <div className="home-3-cards-wrapper">
                <img
            ...
            <div className="home-3-balls-container">
              <div className="home-3-balls-wrapper">
                <img
          ...
          <div className="home-3-main">
            <div className="home-3-main-container">
              <h2 className="home-3-main-container-header">
                <span className="home-3-main-container-header-span">Win </span>
                millions in prizes
              </h2>
              <div className="home-3-main-container-subtext">
                Provably fair, on-chain games.
              </div>
              <div className="home-3-main-container-subtext home-3-main-container-subtext-last">
                Win big with PancakeSwap.
              </div>
              <div className="home-3-main-duo-cards" ref={winMillionRef}>
