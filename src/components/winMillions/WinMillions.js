      ...
      <div className="tabel-centru">
        <div className="inception">
          <div className="container-pred">
            <div className="text-sus">
              <span id="justthecollor">Win</span> millions in prizes
            </div>
            <div className="text-jos">Provably fair, on-chain games.</div>
            <div className="text-jos">Win big with PancakeSwap.</div>
          </div>
          <div className="prediction-container" ref={winMillionRef}>
            <div className="prediction">
              <div className="svglottery">
                <svg
                  viewBox="0 0 24 24"
                  width="36px"
                  color="inverseContrast"
                  xmlns="http://www.w3.org/2000/svg"
                  className="sc-4ba21b47-0 hqPQya"
                >
              ...
              <div className="spacingstuff" id="opq">
                Prediction
              </div>
              <div className="spacingstuff" id="opqr" ref={predictionRef}>
                1.2 billion
              </div>
              <div className="spacingstuff" id="opqrs">
                in BNB + CAKE won so far
              </div>
              <div className="spacingstuff" id="opqrst">
                Predict the price trend of BNB or CAKE to win
              </div>
              <a href="https://pancakeswap.finance/prediction"></a>
              <button className="lotterybutton">
                Play{' '}
                <svg
                  viewBox="0 0 24 24"
            ...
            <div className="lottery">
              <div className="svglottery" id="svgpred">
                <svg
                  viewBox="0 0 24 24"
                  color="white"
                  width="36px"
                  xmlns="http://www.w3.org/2000/svg"
                  className="sc-4ba21b47-0 dMgorE"
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
              ...
              <div className="spacingstuff" id="abc">
                Lottery
              </div>
              <div className="spacingstuff" id="abcd" ref={lotteryRef}>
                <CountUp
                  duration={1}
                  end={80.553}
                  delay={2}
              ...
              <div className="spacingstuff" id="abcde">
                in CAKE prizes this round
              </div>
              <div className="spacingstuff" id="abcdef">
